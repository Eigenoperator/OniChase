...
- Walking speed is a continuous gameplay function for future stamina/fatigue rules, not a discrete UI option set. The current default function returns `5 km/h` (`1.389 m/s`), while the UI does not expose this setting directly.
