...
PHYSICAL_ALIAS_STATION_OPERATORS = {
    ...
    "相鉄いずみ野線": ["sotetsu", "相模鉄道", "相鉄", "odakyu"],
    "相鉄本線": ["sotetsu", "相模鉄道", "相鉄", "jr_east", "odakyu"],
    "相鉄新横浜線": ["sotetsu", "相模鉄道", "相鉄", "jr_east", "tokyu", "jr_central"],
}
...
ROUTE_TRACK_LINE_ALIASES = {
    ...
    "TOEI_MITA": ["6号線三田線", "都営三田線", "相鉄本線", "相鉄新横浜線"],
    "TOEI_NIPPORI_TONERI": ["日暮里・舎人ライナー"],
    ...
    "小田急小田原線通勤": ["小田原線"],
    "小田急江ノ島線": ["江ノ島線"],
    "7号線南北線": ["7号線南北線", "南北線", "埼玉高速鉄道線", "相鉄本線", "相鉄新横浜線"],
    "8号線有楽町線": ["8号線有楽町線", "有楽町線", "みなとみらい21線", "相鉄本線", "相鉄新横浜線"],
    "13号線副都心線": ["13号線副都心線", "副都心線", "東横線", "みなとみらい21線", "相鉄本線", "相鉄新横浜線"],
    "埼玉高速鉄道線": ["埼玉高速鉄道線", "南北線"],
    "相鉄本線": ["相鉄本線", "相鉄いずみ野線", "相鉄新横浜線", "目黒線", "東横線", "東急新横浜線"],
    "相鉄いずみ野線": ["相鉄いずみ野線", "相鉄本線", "相鉄新横浜線", "目黒線", "東横線", "東急新横浜線"],
    "相鉄新横浜線": ["相鉄新横浜線", "相鉄本線", "相鉄いずみ野線", "目黒線", "東横線", "東急新横浜線"],
    "みなとみらい21線": ["みなとみらい21線", "東横線", "池袋線", "西武有楽町線", "副都心線"],
    "会津鬼怒川線": ["鬼怒川線"],
}
ROUTE_THROUGH_SERVICE_LINE_ALIASES = {
    "JR_EAST_SAIKYO_KAWAGOE": ["埼京線", "川越線", "りんかい線", "臨海副都心線", "相鉄本線", "相鉄新横浜線"],
    "JR_KAWAGOE": ["川越線", "八高線"],
    "JR_JOBAN": ["常磐線", "常磐線各駅停車", "千代田線", "9号線千代田線"],
    "RINKAI": ["りんかい線", "臨海副都心線", "埼京線", "川越線"],
    "2号線日比谷線": ["日比谷線", "伊勢崎線"],
    "5号線東西線": ["東西線", "中央線", "総武線"],
    "6号線三田線": ["三田線", "目黒線", "東急新横浜線", "相鉄本線", "相鉄いずみ野線", "相鉄新横浜線"],
    "7号線南北線": ["南北線", "目黒線", "東急新横浜線", "埼玉高速鉄道線", "相鉄本線", "相鉄いずみ野線", "相鉄新横浜線"],
    "8号線有楽町線": ["有楽町線", "西武有楽町線", "池袋線", "東上本線", "東急新横浜線", "相鉄本線", "相鉄いずみ野線", "相鉄新横浜線"],
    "9号線千代田線": ["千代田線", "小田原線", "多摩線", "常磐線"],
    "11号線半蔵門線": ["半蔵門線", "田園都市線", "伊勢崎線", "日光線"],
    "13号線副都心線": ["副都心線", "東横線", "みなとみらい21線", "西武有楽町線", "池袋線", "東上本線", "東急新横浜線", "相鉄本線", "相鉄いずみ野線", "相鉄新横浜線"],
    "中央線": ["中央線", "東西線", "5号線東西線"],
    "総武線": ["総武線", "東西線", "5号線東西線"],
