...
SOURCE_FILES = [
    ...
    ROOT / "data/v5_ship_playable_setonaikai_batch_official.json",
    ROOT / "data/v5_ship_playable_hankyu_batch_official.json",
    ROOT / "data/v5_ship_playable_kamimura_batch_official.json",
    ...
    ROOT / "data/v5_ship_playable_to_500_batch1_official.json",
]
