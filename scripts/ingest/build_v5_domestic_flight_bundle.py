...
INPUTS = [
    ...
    ("solaseed", ROOT / "data/v5_domestic_flights_solaseed_official_20260329_20261024.json"),
    ("orc", ROOT / "data/v5_domestic_flights_orc_official_20260329_20261024.json"),
    ("amx", ROOT / "data/v5_domestic_flights_amx_official_20260329_20261024.json"),
]
...
def main() -> None:
    ...
    out = {
        ...
        "rules": {
            ...
            "anaCodesharePolicy": "ANA all-area timetable is used for ANA/AKX direct records only. Codeshare-operated carriers are represented by their own operator artifacts where available; JAL group current-period XML covers the current JAL/JTA/RAC official window without extrapolation.",
            "dedupeKeys": ["carrier+flight+airports+times+calendarNote", "carrier+airports+times"],
        },
        "inputs": loaded_files,
        "summary": {
            ...
            "remainingMajorSourceGaps": ["JAL/JTA/RAC official July-August timetable", "JAC standalone summer operator labeling if not exposed by JAL XML"],
