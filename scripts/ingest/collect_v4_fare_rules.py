...
MANUAL_OPERATOR_FARE_TABLES = [
    ...
    {
        "key": "keisei_narita_airport_line_202210",
        "operatorIds": ["keisei"],
        "operatorName": "京成電鉄",
        "url": "https://new-www.keisei.co.jp/keisei/tetudou/goriyo/pdf/narita_260314.pdf",
        "notes": [
            "京成電鉄公式の成田空港線適用・旅客営業規則別表第2号の1から、2022年10月1日現在の成田空港線各駅相互発着の大人片道普通運賃だけを収録。",
            "京成高砂-印旛日本医大間各駅相互発着には別表第2号の2の低額表があるが、現行のv4距離表モデルでは同一route内の部分例外を表現できないため未分離。京成電鉄線・北総線との乗継/連絡運賃、スカイライナー料金、定期、小児、割引は別体系のため未収録。",
        ],
        "routeIds": ["V4_ROUTE_80C469C3DADCD3"],
        "rows": [
            (1, 3, 210), (4, 5, 320), (6, 7, 390), (8, 9, 470),
            (10, 11, 530), (12, 14, 600), (15, 17, 660), (18, 20, 720),
            (21, 23, 770), (24, 26, 800), (27, 29, 830), (30, 33, 860),
            (34, 37, 900), (38, 41, 930), (42, 45, 960), (46, 49, 980),
            (50, 52, 1000),
        ],
    },
    {
...
MANUAL_STATION_PAIR_FARE_TABLES: list[dict[str, Any]] = [
    ...
    {
        "key": "daitetsu_main_line_station_pairs_current",
        "operatorIds": ["大井川鐵道"],
        "operatorName": "大井川鐵道",
        "url": "https://daitetsu.jp/ft_main",
        "notes": [
            "大井川鐵道公式の大井川本線時刻表・運賃ページから、現在鉄道として運行されている金谷-川根温泉笹間渡間の大人普通運賃だけを収録。",
            "2022年台風被害により川根温泉笹間渡-千頭間は不通で、公式ページでも川根本町コミュニティーバスへの乗換案内となっているため、この表は大井川鐵道の鉄道運賃として当該区間を覆わない。",
            "小児運賃、SL/EL急行料金、座席指定、定期、企画乗車券、町営バス運賃は別体系のため未収録。",
        ],
        "routeIds": ["V4_ROUTE_D988021AEC3AF3"],
        "pairs": station_pair_upper_triangle_rows(
            ["金谷", "新金谷", "代官町", "日切", "合格", "門出", "神尾", "福用", "大和田", "家山", "抜里", "川根温泉笹間渡"],
            [
                ("金谷", [150, 190, 230, 230, 280, 460, 600, 690, 830, 880, 920]),
                ("新金谷", [150, 150, 150, 190, 370, 460, 600, 690, 780, 830]),
                ("代官町", [150, 150, 150, 280, 420, 510, 650, 690, 780]),
                ("日切", [150, 150, 280, 370, 510, 600, 690, 740]),
                ("合格", [150, 230, 370, 460, 600, 650, 690]),
                ("門出", [230, 330, 460, 550, 650, 690]),
                ("神尾", [150, 230, 370, 420, 510]),
                ("福用", [150, 230, 330, 370]),
                ("大和田", [150, 190, 280]),
                ("家山", [150, 150]),
                ("抜里", [150]),
    ...
    {
        "key": "echizen_mikuni_awara_station_pairs_202403",
        "operatorIds": ["えちぜん鉄道"],
        "operatorName": "えちぜん鉄道",
        "url": "https://www.echizen-tetudo.co.jp/.assets/%E6%97%85%E5%AE%A2%E9%81%8B%E8%B3%83%E8%A1%A8.pdf",
        "notes": [
            "えちぜん鉄道公式の2024年3月16日改正・旅客運賃表PDFから、三国芦原線のえちぜん鉄道社線内だけを転記。",
            "ゲーム側の三国芦原線 route には福井鉄道直通区間も混在するため、田原町以南の福井鉄道駅との連絡運賃はここでは覆わない。",
            "回数券、通勤定期、通学定期、障害者割引、福井鉄道連絡運賃は別体系のため未収録。",
        ],
        "routeIds": ["V4_ROUTE_C377215EF3D4AB"],
        "pairs": station_pair_triangle_rows(
            [
                "福井",
                "新福井",
            ...
            [
                ...
                ("まつもと町屋", [180, 180, 180]),
                ("西別院", [180, 180, 180, 180]),
                ("田原町", [180, 180, 180, 180, 180]),
                ("福大前西福井", [200, 180, 180, 180, 180, 180]),
                ("日華化学前", [260, 260, 240, 240, 180, 180, 180]),
                ("八ツ島", [280, 280, 280, 240, 240, 220, 180, 180]),
                ("新田塚", [300, 300, 300, 240, 240, 240, 180, 180, 180]),
                ("中角", [370, 370, 300, 300, 300, 240, 240, 240, 180, 180]),
                ("鷲塚針原", [430, 430, 430, 370, 370, 300, 300, 300, 240, 240, 240]),
                ("太郎丸エンゼルランド", [490, 490, 430, 430, 370, 370, 370, 300, 300, 300, 240, 180]),
                ("西春江ハートピア", [490, 490, 490, 430, 430, 370, 370, 370, 300, 300, 300, 180, 180]),
                ("西長田ゆりの里", [560, 560, 490, 490, 490, 430, 430, 430, 370, 370, 300, 240, 240, 180]),
                ("下兵庫こうふく", [620, 620, 560, 560, 490, 490, 490, 430, 430, 430, 370, 300, 300, 240, 180]),
                ("大関", [620, 620, 620, 620, 560, 560, 560, 490, 490, 490, 430, 370, 370, 300, 240, 180]),
                ("本荘", [670, 670, 670, 620, 620, 620, 620, 560, 560, 560, 490, 430, 430, 370, 300, 240, 180]),
                ("番田", [670, 670, 670, 670, 620, 620, 620, 620, 620, 560, 560, 490, 430, 430, 370, 300, 240, 180]),
                ("あわら湯のまち", [730, 730, 670, 670, 670, 670, 670, 620, 620, 620, 620, 490, 490, 430, 430, 370, 300, 240, 180]),
                ("水居", [780, 730, 730, 730, 730, 670, 670, 670, 670, 670, 620, 560, 560, 490, 490, 430, 370, 300, 240, 180]),
                ("三国神社", [780, 780, 780, 730, 730, 730, 730, 670, 670, 670, 670, 620, 620, 560, 490, 430, 370, 300, 300, 240, 180]),
                ("三国", [780, 780, 780, 780, 730, 730, 730, 730, 670, 670, 670, 620, 620, 620, 560, 490, 430, 370, 300, 300, 240, 180]),
                ("三国港", [820, 820, 780, 780, 780, 780, 730, 730, 730, 730, 670, 670, 620, 620, 560, 490, 430, 370, 370, 300, 240, 180, 180]),
            ],
        ),
    },
    {
        "key": "tosaden_tram_boundary_pairs_202411",
        "operatorIds": ["とさでん交通"],
        "operatorName": "とさでん交通",
        "url": "https://www.tosaden.co.jp/download/?fid=10195&id=1087&t=LD",
        "notes": [
            "とさでん交通公式の電車運賃表PDF（令和6年11月1日改正）から、市内均一230円区間と、整理券番号境界として図示されている主要電停間の大人普通運賃を転記。",
            "同PDFは線形の全停留場三角表ではなく、方面別の整理券境界表であるため、ここでは図上に明示された境界電停と市内均一区間だけを収録する。ICカード、小児、障害者割引、乗換券、定期、団体、バス乗継は別体系のため未収録。",
        ],
        "routeIds": [
            "V4_ROUTE_7529BA7DF96391",
            "V4_ROUTE_4145DA0B683BAA",
            "V4_ROUTE_10F94645CAC451",
            "V4_ROUTE_0822B9B6D6BD1C",
        ],
        "pairs": (
            station_pair_flat_rows(
                ["曙町東町", "鴨部", "旭駅前通", "桟橋通五丁目", "高知駅前", "知寄町三丁目", "はりまや橋"],
                230,
            )
            + [
                ("伊野", "八代通", 150),
    ...
    {
        "key": "beppu_rakutenchi_cable_product_2026",
        "operatorIds": ["ラクテンチ"],
        "operatorName": "ラクテンチ",
        "url": "https://rakutenchi.jp/guidance/price/",
        "notes": [
            "別府ラクテンチ公式料金案内では、メインゲート入園料がケーブルカー往復乗車券付で大人1,300円、乙原ゲート入園料が大人1,100円と掲載されている。",
            "公式ページ上にケーブルカー単独の片道普通運賃は掲載されていないため、この表は大人入園商品のケーブルカー往復相当差額200円を現在売られている実商品ベースの値として収録する。小人、シニア、障がい者割引、フリーパス、団体、駐車料金は別体系のため未収録。",
        ],
        "routeIds": ["V4_ROUTE_5CB0883EF823E3"],
        "pairs": [("雲泉寺", "乙原", 200)],
    },
    {
        "key": "kurobe_gorge_partial_roundtrip_products_2026",
        "operatorIds": ["黒部峡谷鉄道"],
        "operatorName": "黒部峡谷鉄道",
        "url": "https://www.kurotetu.co.jp/fare/",
        "notes": [
            "黒部峡谷鉄道公式の2026年4月20日-9月30日運賃案内から、部分運行中に発売されている大人往復商品を収録。宇奈月-黒薙往復は1,660円、宇奈月-猫又往復は2,820円。",
            "2026年9月30日までは宇奈月-猫又の部分運行で、猫又でのトイレ休憩を含む同一客車往復利用として案内されているため、通常期の宇奈月-欅平全線片道/往復運賃、リラックス客車券、小児、団体、障害者割引、10月以降の未定区間は未収録。",
        ],
        "routeIds": ["V4_ROUTE_5F40A90499EB16"],
        "pairs": [
            ("宇奈月", "黒薙", 1660),
            ("宇奈月", "猫又", 2820),
        ],
