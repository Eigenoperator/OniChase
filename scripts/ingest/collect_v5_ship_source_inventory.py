...
SOURCES = [
    ...
    {
        "id": "orange_ferry_toyo_osaka",
        "priority": 1,
        "operator": "四国開発フェリー",
        "routeGroup": "東予/新居浜・神戸/大阪",
        "ports": ["東予港", "新居浜港", "神戸港", "大阪南港"],
        "officialUrls": ["https://www.orange-ferry.co.jp/"],
        "notes": "Added during validation from Shikoku passenger-ship association cross-check.",
    },
    {
        "id": "matsuyama_kokura_ferry",
        "priority": 1,
        "operator": "松山・小倉フェリー",
        "routeGroup": "松山・小倉",
        "ports": ["松山観光港", "小倉港"],
        "officialUrls": ["https://www.matsuyama-kokuraferry.co.jp/"],
        "notes": "Overnight Setouchi-Kyushu route added during validation.",
    },
    {
        "id": "sadokisen",
        "priority": 2,
    ...
    },
    {
        ...
        "routeGroup": "東京・父島",
        "ports": ["竹芝", "父島二見港"],
        "officialUrls": ["https://www.ogasawarakaiun.co.jp/"],
        "notes": "Critical remote-island trunk; long voyage should use long/night reveal.",
    },
    {
        "id": "izu_shoto_kaihatsu",
        "priority": 2,
        "operator": "伊豆諸島開発",
        "routeGroup": "八丈島・青ヶ島 / 父島・母島",
        "ports": ["八丈島", "青ヶ島", "父島", "母島"],
        "officialUrls": ["https://www.tokaikisen.co.jp/"],
        "notes": "MLIT lists this under the Tokai Kisen link; confirm official route pages before playable promotion.",
    },
    {
        "id": "nankai_ferry",
        "priority": 3,
    ...
    },
    {
        ...
        "routeGroup": "鳥羽・伊良湖",
        "ports": ["鳥羽港", "伊良湖港"],
        "officialUrls": ["https://www.isewanferry.co.jp/"],
        "notes": "Kintetsu/Meitetsu-side regional shortcut.",
    },
    {
        "id": "suruga_bay_ferry",
        "priority": 3,
        "operator": "ふじさん駿河湾フェリー",
        "routeGroup": "清水・土肥",
        "ports": ["清水港", "土肥港"],
        "officialUrls": ["https://www.223-ferry.or.jp/"],
        "notes": "Suruga Bay shortcut.",
    },
    {
        "id": "tsu_airport_line",
        "priority": 3,
        "operator": "津エアポートライン",
        "routeGroup": "津新港・中部国際空港",
        "ports": ["津新港", "空港島"],
        "officialUrls": ["https://www.tsu-airportline.co.jp/"],
        "notes": "Airport-access ship link; later integrate with flight airport nodes.",
    },
    {
        "id": "kobe_kanku_bay_shuttle",
        "priority": 3,
        "operator": "こうべ未来都市機構",
        "routeGroup": "神戸空港・関西空港",
        "ports": ["神戸空港海上アクセスターミナル", "関西空港"],
        "officialUrls": ["https://www.kobe-access.jp/"],
        "notes": "Airport-to-airport sea access; high V5 multimodal value.",
    },
    {
    ...
    {
        "id": "suo_oshima_matsuyama_ferry",
        "priority": 3,
        "operator": "周防大島松山フェリー",
        "routeGroup": "柳井・伊保田・松山",
        "ports": ["柳井港", "伊保田港", "三津浜港"],
        "officialUrls": ["https://www.suo-oshima-matsuyamaferry.com/"],
        "notes": "Overlap risk with Boyo Ferry on Yamaguchi-Ehime corridor.",
    },
    {
        "id": "suonada_ferry",
        "priority": 3,
        ...
        "routeGroup": "徳山・竹田津",
        "ports": ["徳山港", "竹田津港"],
        "officialUrls": ["https://www.suonada.co.jp/"],
        "notes": "Yamaguchi-Oita shortcut.",
    },
    {
    ...
    },
    {
        ...
        "operator": "九州郵船",
        "routeGroup": "博多・壱岐・対馬",
        "ports": ["博多港", "郷ノ浦港", "芦辺港", "厳原港", "比田勝港", "印通寺港", "唐津東港"],
        "officialUrls": ["https://www.kyu-you.co.jp/"],
        "notes": "Major Kyushu island trunk; ferry and jetfoil/high-speed service classes must stay separate.",
    },
    {
        "id": "amami_kaiun",
        "priority": 2,
        "operator": "奄美海運",
        "routeGroup": "鹿児島・喜界・奄美群島",
        "ports": ["鹿児島新港", "喜界港", "名瀬港", "古仁屋港", "平土野港", "知名港"],
        "officialUrls": ["https://www.aline-ferry.com/"],
        "notes": "Separate island-chain operator from Marue/Marix trunk.",
    },
    {
        "id": "ariake_ferry",
        "priority": 3,
        "operator": "有明海自動車航送船組合",
        "routeGroup": "多比良・長洲",
        "ports": ["多比良港", "長洲港"],
        "officialUrls": ["https://www.ariake-ferry.com/"],
        "notes": "Ariake Sea shortcut.",
    },
    {
        "id": "sanwa_ferry",
        "priority": 3,
        ...
        "routeGroup": "蔵之元・牛深",
        "ports": ["蔵之元港", "牛深港"],
        "officialUrls": ["https://ezax.co.jp/"],
        "notes": "Amakusa-Kagoshima link.",
    },
    {
        "id": "miyajima_ferries",
        "priority": 3,
    ...
    {
        "id": "awaji_jenova_line",
        "priority": 3,
        "operator": "淡路ジェノバライン",
        "routeGroup": "明石・岩屋",
        "ports": ["明石港", "岩屋港"],
        "officialUrls": ["https://www.jenova-line.co.jp/"],
        "notes": "Short but transport-useful public route.",
    },
    {
        "id": "shikoku_kisen_naoshima",
        "priority": 3,
        "operator": "四国汽船",
        "routeGroup": "高松/宇野・直島",
        "ports": ["高松港", "宇野港", "宮浦港", "本村港"],
        "officialUrls": ["https://www.shikokukisen.com/"],
        "notes": "Naoshima public island access; check tourist-heavy but scheduled transport.",
    },
    {
        "id": "sakurajima_ferry",
        "priority": 3,
        ...
        "routeGroup": "鹿児島・桜島",
        "ports": ["鹿児島港", "桜島港"],
        "officialUrls": ["https://www.city.kagoshima.lg.jp/"],
        "notes": "High-frequency public ferry; collect after trunk routes.",
    },
    {
        "id": "tarumizu_ferry",
        "priority": 3,
        ...
        "routeGroup": "鴨池・垂水",
        "ports": ["鴨池港", "垂水港"],
        "officialUrls": ["https://www.iwasaki-corp.com/"],
        "notes": "Kagoshima Bay shortcut.",
    },
]
