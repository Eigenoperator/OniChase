...
- Refined v3 planning rows: terminal-only trains and duplicate boardable services are filtered, direct-through aliases are hidden from line choices/transfers, compact two-row line-symbol assets are used, and Keikyu airport trains reach Haneda terminals.
