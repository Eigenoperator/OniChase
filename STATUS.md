...
- v4 route-choice QA now globally scans all `9052` station groups for segment mismatches, virtual-corridor leaks, generic `路線`, remote Yokohama through routes/labels, selected-train label violations, JR East northern-trunk scope, and major-station Shinkansen visibility through transfer-equivalent station groups; latest scan reports `1675021` rows, `1675374` choices/labels, and `0` anomalies.
