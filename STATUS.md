...
- v3 planner is now a three-layer `line -> train -> destination stop` flow with compact transfer grids, physical train filtering, and fast selected-train highlights for future physical segments/stops.
