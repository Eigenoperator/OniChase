...
- v4 long-distance playability audit now validates `30` real staged routes, including remote endpoints such as 白浜, 宇和島, 枕崎, 稚内, 根室, 大湊, 女川, 奥多摩, 南小谷, 境港, 奈半利, and 宿毛; latest run reports `30/30` playable and `0` anomalies.
