...
- Public `v4.html` now displays the nationwide physical railway map with MapLibre, mutually exclusive zoom-tiered station labels, optional physical station dots, line search, and selected-line highlighting.
